...
public class OpenAPIConfig {
	...
	public OpenAPI myOpenAPI() {
		...
		Info info=  new Info().title("SMSNotification MS API").version("1.0").contact(contact)
				.description("This API exposes endpoints to send sms-notifications to phone number.").termsOfService("https://www.mstproject.com/terms")
				.license(mitLicense);
