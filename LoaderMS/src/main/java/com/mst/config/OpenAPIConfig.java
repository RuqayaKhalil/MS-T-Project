...
public class OpenAPIConfig {
	...
	public OpenAPI myOpenAPI() {
		...
		Info info=  new Info().title("Loader MS API").version("1.0").contact(contact)
				.description("This API exposes endpoints to load csv-files from gitHub.").termsOfService("https://www.mstproject.com/terms")
				.license(mitLicense);
