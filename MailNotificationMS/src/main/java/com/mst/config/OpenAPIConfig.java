...
public class OpenAPIConfig {
	...
	public OpenAPI myOpenAPI() {
		...
		Info info=  new Info().title("MailNotification MS API").version("1.0").contact(contact)
				.description("This API exposes endpoints to send mail-notifications to Email.").termsOfService("https://www.mstproject.com/terms")
				.license(mitLicense);
